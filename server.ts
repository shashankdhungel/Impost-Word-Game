...
const WORDS_DATABASE = {
  ...
  "Superheroes": ["Superman", "Batman", "Wonder Woman", "Spider-Man", "Iron Man", "Captain America", "Thor", "Hulk", "Hawkeye", "Aquaman", "Green Lantern", "Storm", "Black Panther", "Doctor Strange", "Shazam", "Flash", "Wolverine", "Deadpool"],
  "Nepali Food": ["Momo", "Dal Bhat", "Gundruk", "Aloo Gobi", "Samosa", "Chowmein", "Sekuwa", "Sel Roti", "Dhedo", "Juju Dhau", "Bara", "Kheer", "Puri", "Thali", "Chatamari", "Yomari", "Lapsi", "Kwati", "Sikarni", "Aloo Tama", "Sukuti", "Chura Dahi", "Thukpa", "Bhatmas Sadeko", "Newari Khaja Set"],
  "Nepali Places": ["Kathmandu", "Pokhara", "Everest", "Bhaktapur", "Lalitpur", "Pashupatinath", "Swayambhunath", "Boudhanath", "Chitwan", "Janakpur", "Annapurna", "Thamel", "Nuwakot", "Gorkha", "Nagarkot", "Bandipur", "Ilam", "Jhapa", "Lumbini", "Mustang", "Rara Lake", "Phewa Lake", "Namche Bazaar", "Gosaikunda", "Tansen"],
  "Nepali Festivals": ["Dashain", "Tihar", "Losar", "Holi", "Bisket Jatra", "Teej", "Shivaratri", "Indra Jatra", "Rato Machhindranath", "Raaksha Bandhan", "Nepali New Year", "Naga Panchami", "Makar Sankranti", "Ghatasthapana", "Bijaya Dashami", "Govardhan Puja", "Bhai Tika", "Chhath", "Maghe Sankranti", "Gai Jatra", "Ghode Jatra", "Sakela", "Tamu Losar"],
  "Bollywood Movies": ["Dilwale", "Sholay", "Amar Akbar Anthony", "Kabhie Khushi Kabhi Gham", "Rang De Basanti", "3 Idiots", "Devdas", "Kal Ho Naa Ho", "Chak De India", "Bajrangi Bhaijaan", "Queen", "PK", "Barfi", "Dangal", "Dil Chahta Hai", "Lagaan", "Munna Bhai", "Taare Zameen Par", "Gangs of Wasseypur", "Andhadhun"],
  "Cricket Players": ["Virat Kohli", "MS Dhoni", "Sachin Tendulkar", "Sandeep Lamichhane", "Paras Khadka", "Sompal Kami", "Rohit Sharma", "Babar Azam", "Joe Root", "Steve Smith", "Kane Williamson", "Ben Stokes", "Jasprit Bumrah", "Pat Cummins", "Shakib Al Hasan", "Rohit Paudel", "Dipendra Singh Airee", "Kushal Bhurtel"],
  "Nepali Politicians": ["KP Sharma Oli", "Prachanda", "Sher Bahadur Deuba", "Balen Shah", "Sudan Gurung", "Rabi Lamichhane", "Ram Chandra Paudel", "Madhav Kumar Nepal", "Upendra Yadav", "Baburam Bhattarai", "BP Koirala", "Girija Prasad Koirala", "Madan Bhandari"],
  "Nepali Street Food": ["Pani Puri", "Chatpate", "Samosa", "Chowmein", "Momo", "Sekuwa", "Choila", "Sel Roti", "Titaura", "Dosa", "Aloo Chop", "Pakoda", "Bread Omelette", "Wai Wai Sadeko", "Anda Bhurji", "Corn", "Sausage"],
  "Nepali Culture": ["Deusi Bhailo", "Dhaka Topi", "Gunyu Cholo", "Khukuri", "Mandala", "Thangka", "Madal", "Sarangi", "Pashmina", "Kumari", "Lakhey Dance", "Newari Culture", "Dhaka Fabric", "Topi", "Dhoka"],
  "Nepali Singers": ["Narayan Gopal", "Aruna Lama", "Deepak Bajracharya", "Ani Choying", "Swoopna Suman", "Bartika Eam Rai", "Sugam Pokhrel", "Sushant KC", "Paul Shah", "Melina Rai", "Prakash Saput", "Sabin Rai", "Neetesh Jung Kunwar", "Adrian Pradhan", "Bipul Chettri"],
  "Nepali Movies": ["Kabaddi", "Loot", "Chhakka Panja", "Pashupati Prasad", "Talakjung Vs Tulke", "Kalo Pothi", "Highway", "Woda Number Six", "Numafung", "Paradeshi", "Kagbeni", "Basanti", "Loot 2", "Bhairav", "Lappan Chhappan"],
  "Football Players": ["Messi", "Ronaldo", "Neymar", "Mbappe", "Benzema", "Modric", "Salah", "De Bruyne", "Haaland", "Lewandowski", "Rooney", "Beckham", "Zidane", "Ronaldinho", "Pele"],
  "Social Media Apps": ["Facebook", "Instagram", "TikTok", "YouTube", "Twitter", "Snapchat", "WhatsApp", "Telegram", "LinkedIn", "Pinterest", "Reddit", "Discord", "Viber", "IMO", "Messenger"],
  "Hollywood Movies": ["Avengers", "The Dark Knight", "Interstellar", "Joker", "John Wick", "Jurassic Park", "Harry Potter", "Lord of the Rings", "Forrest Gump", "The Godfather", "Pulp Fiction", "Fight Club", "Shutter Island", "Parasite", "Oppenheimer"],
  "Animals in Nepal": ["Snow Leopard", "Red Panda", "Bengal Tiger", "One Horned Rhino", "Elephant", "Gharial", "Himalayan Bear", "Musk Deer", "Gangetic Dolphin", "Yak", "Blue Sheep", "Danfe", "Langur", "Wild Boar", "Peacock"],
  "Nepali Games": ["Dandi Biyo", "Kabaddi", "Bagh Chal", "Lagori", "Kho Kho", "Guchcha", "Marbles", "Lattoo", "Pinge", "Chibi"],
  "Web Series": ["Stranger Things", "Money Heist", "Breaking Bad", "Game of Thrones", "Squid Game", "Dark", "Peaky Blinders", "The Crown", "Narcos", "Wednesday", "Black Mirror", "Ozark", "The Witcher", "Lupin", "Sacred Games"],
  "Nepali Brands": ["Wai Wai", "CG", "Goldstar", "Aaha Cola", "Himalayan Java", "Bhatbhateni", "eSewa", "Khalti", "Ncell", "Nepal Telecom", "Dabur Nepal", "Surya Nepal", "Jagdamba", "Fliz", "Foodmandu"],
  "Nepali Churot": ["Surya", "Yak", "Khukuri", "Shikhar", "Bijuli", "Nepal", "Gorkha", "Mustang", "Himalaya", "Classic", "Bristol", "Panama", "Kings", "Tara", "Casino"],
};
